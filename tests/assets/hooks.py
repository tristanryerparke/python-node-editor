...
def pre_inputs_only_terminal_output(inputs) -> None:
    print("PRE HOOK OUTPUT")
    HOOK_EVENTS.append(("pre_inputs_only_terminal_output", {"inputs": dict(inputs)}))
...
@add_node_options(node_name="Hooked Add Pre Output", return_value_name="sum")
@pre_execution_hook(pre_inputs_only_terminal_output)
def add_with_terminal_pre_hook(a: int, b: int) -> int:
